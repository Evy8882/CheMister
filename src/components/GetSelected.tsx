...
function GetSelected({ selected, color, fntColor }: GetSelectedProps) {
  if (selected) {
    return (
      <>
        <div
          className="element selected-element"
          style={{
        ...
        >
          ...
          <p>
            <strong>Período:</strong> {selected.period}
          </p>
          <p>
            <strong>Categoria:</strong> {selected.category || "N/A"}
          </p>
          <p>
            <strong>Estado Físico:</strong> {selected.state || "N/A"}
          </p>
          <p>
